...
const SIGNALS = [
  ...
  { id: 4, date: "2026-05-11", company: "Privy", stage: "Series A", func: "Engineering", type: "hiring_trigger", signal: "Post-acquisition integration creating eng leadership vacuum. Need someone who can run both legacy and new platform teams. Player-coach archetype.", source: "Board advisor", vcRef: "Paradigm", enrichment: { raised: "$18M Series A", headcount: "35", news: "Acquired by larger wallet infra company, integration underway" } },
  ...
  { id: 7, date: "2026-05-08", company: "Midas", stage: "Seed", func: "Engineering", type: "hiring_trigger", signal: "Tokenized T-bills product live, need to hire first 3 engineers. Founders are non-technical. Asked for help defining eng hiring bar and interview process.", source: "Founder meeting", vcRef: "Framework Ventures", enrichment: { raised: "$8M Seed", headcount: "6", news: "TVL crossed $500M on tokenized treasury product" } },
  ...
  { id: 10, date: "2026-05-05", company: "Phantom", stage: "Series B", func: "Engineering", type: "capability_gap", signal: "Multichain wallet strategy requires protocol eng talent they don't have in-house. Need 2-3 senior protocol engineers. Specific skillset, small market.", source: "Founder meeting", vcRef: "Paradigm", enrichment: { raised: "$118M Series B", headcount: "55", news: "Launched Bitcoin and Sui support, 15M MAU" } },
  ...
  { id: 14, date: "2026-05-02", company: "EigenLayer", stage: "Series A", func: "Engineering", type: "hiring_trigger", signal: "Protocol complexity requires specialized distributed systems talent. Have budget but can't find candidates with both crypto and distributed systems depth.", source: "Founder meeting", vcRef: "Blockchain Capital", enrichment: { raised: "$50M Series A", headcount: "45", news: "Restaking TVL crossed $15B, launched EigenDA" } },
...
const VC_RELATIONSHIPS = [
  ...
  { firm: "Paradigm", tier: "active", signals: 3, engagements: 1, contacts: ["Dan Robinson (research)"], lastTouch: "2026-05-11" },
  ...
  { firm: "Framework Ventures", tier: "active", signals: 2, engagements: 1, contacts: ["Vance Spencer (GP)"], lastTouch: "2026-05-08" },
  { firm: "Blockchain Capital", tier: "building", signals: 1, engagements: 0, contacts: ["Spencer Bogart"], lastTouch: "2026-05-02" },
...
const SYNCED_MEETINGS = [
  ...
  { id: "s3", time: "May 12", title: "Paradigm intro: Phantom eng needs", attendees: "Dan Robinson", notetaker: "granola", signalsExtracted: 2 },
  { id: "s4", time: "May 11", title: "Privy post-acquisition eng debrief", attendees: "Henri Stern (CEO)", notetaker: "granola", signalsExtracted: 1 },
...
export default function SignalBoard() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: T.bg, color: T.text, fontFamily: T.sans }}>
      ...
      <footer style={{ marginTop: "auto", padding: mobile ? "16px" : "20px 24px", borderTop: `1px solid ${T.border}`, display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "8px" }}>
        <span style={{ fontFamily: T.mono, fontSize: "10px", color: T.textDim, textTransform: "uppercase", letterSpacing: "0.08em" }}>Sonar · Signal Intelligence</span>
        <a href="https://github.com/beingmtm714/sonar-riviera" target="_blank" rel="noopener noreferrer" style={{ fontFamily: T.mono, fontSize: "10px", color: T.accent, textDecoration: "none", textTransform: "uppercase", letterSpacing: "0.08em", display: "flex", alignItems: "center", gap: "5px" }}>
